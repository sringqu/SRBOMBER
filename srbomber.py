...
# Author: sringqu
# GitHub: https://github.com/sringqu
# Version: 4.1.0
#########################################
...
def update():
    ...
    try:
        parsedData = requests.get("https://raw.githubusercontent.com/sringqu/SR-BOMBER/main/more/.version").json()
    except:
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf SRBOMBER && git clone https://github.com/srringqu/SRBOMBER > /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("\n    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd SRBOMBER && python Tbomb.py")
...
\033[94m   │".center(columns+15))
    ...
    print("\033[94m│ \033[95mAuthor : SRINGQU                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/sringqu \033[94m│".center(columns+9))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mSRBOMBER\n")
        time.sleep(0.6)
